...
const VacanciesRouterCompose = require('../domain/composies/VacanciesRouterCompose')
...
routes.get('/vacancies', authValidation, (req, res) => {
  new VacanciesRouterCompose().compose().route(req, res)
})
